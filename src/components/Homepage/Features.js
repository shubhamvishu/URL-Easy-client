        ...
        <section style={{zIndex:"3"}}>
            <div className="ui vertical stripe segment">
                <div className="ui middle aligned stackable grid container">
                    <div className="row">
                        <div className="c1text eight wide column">
                        ...
                        <div className="c1image six wide right floated column">
                            <img src={bgImage}/>
                        </div>
                    </div>
            
                    <div className="row">       
                        <div className="c2image six wide right floated column">
                            <img src={bgImage2}/>
                        </div>
                        <div className="c2text eight wide column">
