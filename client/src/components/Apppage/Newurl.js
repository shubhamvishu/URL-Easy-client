        ...
        <>
            <div style={{position:"absolute",zIndex:"100",width:"100%",height:"100vh",padding:"0"}}>
                <div style={{zIndex:"100"}}>
                    <Header as='h1' style={{backgroundColor:"#e3f5ff",color:"#0b568f",padding:"1em",boxShadow:"10px 10px 40px #ddd"}} onClick={()=> setVisible(!visible)}>Create Tiny URLs</Header>
                    <input style={{width:"60%",padding: "0.7em",backgroundColor:"white",borderRadius:"5px",border: "none",boxShadow:"20px 20px 50px #ddd",marginTop:"30px"}} ref={refurl}/>
                    ...
                    {(errmsg!="")?
                        <Message negative style={{width:"60%",fontSize:"0.8em",marginLeft:"auto",marginRight:"auto"}}>
                            <Message.Header>An error occurred while generating thr tiny url</Message.Header>
                            <p>{errmsg}</p>
                        </Message>:""}
